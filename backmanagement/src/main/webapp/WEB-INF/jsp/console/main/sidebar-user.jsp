...
<li class="user-panel">
	<div class="thumb">
		<img src="${webroot}/images/user/default-admin.png" alt="" class="img-circle" />
	</div>
	<div class="info">
		...
		<ul class="list-inline list-unstyled">
			...
			<li><a href="${webroot}/j_spring_security_logout" data-hover="tooltip" title="退出登录"><i class="fa fa-sign-out"></i></a></li>
		</ul>
	</div>
