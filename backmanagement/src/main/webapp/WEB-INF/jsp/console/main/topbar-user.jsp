...
<li class="dropdown topbar-user" style="width:150px;">
	<a data-hover="dropdown" href="#" class="dropdown-toggle">
		<img src="${webroot}/images/user/default-admin.png" alt="" class="img-responsive img-circle" />&nbsp;
	...
	<ul class="dropdown-menu dropdown-user pull-right">
		...
		<li class="divider"></li>
		 -->
		<li><a href="${webroot}/j_spring_security_logout"><i class="fa fa-sign-out"></i>退出登录</a></li>
	</ul>
</li>