...
<link type="text/css" rel="stylesheet"
	href="${webroot}/madmin/vendors/jquery-ui-1.10.4.custom/css/ui-lightness/jquery-ui-1.10.4.custom.min.css">
<link type="text/css" rel="stylesheet"
	href="${webroot}/madmin/vendors/font-awesome/css/font-awesome.min.css">
<link type="text/css" rel="stylesheet"
	href="${webroot}/madmin/vendors/bootstrap/css/bootstrap.min.css">
<!--Loading style vendors-->
<link type="text/css" rel="stylesheet"
	href="${webroot}/madmin/vendors/iCheck/skins/all.css">
<!--Loading style-->
<link type="text/css" rel="stylesheet"
	href="${webroot}/madmin/css/themes/style1/pink-blue.css"
	class="default-style">
<link type="text/css" rel="stylesheet"
	href="${webroot}/madmin/css/themes/style1/pink-blue.css"
...
<body id="signin-page">
	<div class="page-form new-login-form">
		<form action="${webroot}/j_spring_security_check" class="form"
			method="post">
			...
			<div class="body-content">
				...
				<div class="form-group">
					<div class="checkbox-list new-login-back">
						<label> <input name="rememberMe" value="true"
							type="checkbox">&nbsp;记住密码
						</label>
					</div>
				</div>
