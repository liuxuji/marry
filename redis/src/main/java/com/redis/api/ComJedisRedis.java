...
/**
 * Created this file:
 * jedis提供的接口，里面方法参考自 Jedis提供的方法
 * 在该模块中，有2个不同的实现
 * 1.JedisRedis 适用于单机环境
 * 2.ShardedJedisRedis 适用于多机环境，集群
 * @Author xiaobo.xiong
 * @Date 2017-10-13  17:33
 */
public interface ComJedisRedis <T>{
    ...
    ScanResult<String> sscan(String key, long cursor, int count);
